...
conn = sqlite3.connect("SAAM_database_test3.db")

c = conn.cursor()

def tableCreate():
	c.execute("CREATE TABLE Player_Data (Player_ID INT, Player_name TEXT, IP_address TEXT")
	c.execute("CREATE TABLE Player_Action (Action_ID INT, Player_ID INT, Current_step_ID INT, Previous_step_ID INT, Story_ID INT, Character_ID INT)")
	c.execute("CREATE TABLE Archived_Player_Data (Player_ID INT, Player_name TEXT, e_mail, TEXT, Password TEXT)")
	c.execute("CREATE TABLE Archived_Player_Action (Action_ID INT, Player_ID INT, Current_step_ID INT, Previous_step_ID INT, Story_ID INT, Character_ID INT)")
